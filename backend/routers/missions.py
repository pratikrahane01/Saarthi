...
async def generate_mission(request_body: MissionRequest, request: Request) -> MissionResponse:
    ...
    return MissionResponse(
        ...
        framework=test_result.framework,
        hiddenTest=test_result.hidden_test,
        solutionBefore=dynamic_mission.solutionBefore or "",
        solutionAfter=dynamic_mission.solutionAfter or "",
        solutionExplanation=dynamic_mission.solutionExplanation or "",
    )
