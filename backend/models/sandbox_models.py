...
class SandboxQuestion(BaseModel):
    ...
    Each question contains its own challenge description, scaffold code,
    ...
    scaffoldCode: str = Field(
        ...,
        description="Code scaffold for the student to work with — a new snippet with a similar bug.",
    )
...
class SandboxGenerateResponse(BaseModel):
    ...
    Contains 3 similar practice questions for the student to solve.
    """
    ...
    questions: list[SandboxQuestion] = Field(
        ...,
        description="List of 3 similar practice questions for the student to solve.",
        min_length=1,
        max_length=5,
    )
                ...
                "questions": [
                    {
                        ...
                        "testCriteria": "The function should return the sum of its two arguments.",
                    },
                    {
                        "challenge": "This multiply function has a subtle operator mistake.",
                        "scaffoldCode": "def multiply(a, b):\n    return a / b\n",
                        "hints": [
                            "Check the operator used in the return statement.",
                            "Division and multiplication are different operations.",
                            "The function name says 'multiply'.",
                        ],
                        "testCriteria": "The function should return the product of its two arguments.",
                    },
                    {
                        "challenge": "This subtraction function isn't doing what it says.",
                        "scaffoldCode": "def subtract(a, b):\n    return a + b\n",
                        "hints": [
                            "Look at the arithmetic operator.",
                            "Adding is not the same as subtracting.",
                            "The function name says 'subtract'.",
                        ],
                        "testCriteria": "The function should return the difference of its two arguments.",
                    },
                ],
            }
        }
